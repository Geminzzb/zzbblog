...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Compact;
...
CREATE TABLE `sg_comment`  (
  ...
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_comment` VALUES (31, '0', 5, -1, '222\n', -1, -1, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (32, '0', 1, 2, '21321', 1, 17, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (33, '0', 5, -1, '23321', -1, -1, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (34, '0', 5, 31, '3213', 1, 31, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (35, '0', 5, 33, '32131', 1, 33, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (36, '0', 5, 33, '321', 1, 35, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (37, '1', 1, -1, '321321', -1, -1, 1, NULL, NULL, NULL, 0);
INSERT INTO `sg_comment` VALUES (38, '1', 1, 37, '23121', 1, 37, 1, NULL, NULL, NULL, 0);
...
CREATE TABLE `sg_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标签' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_user`  (
  ...
  `del_flag` int(11) NULL DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14787164048663 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
